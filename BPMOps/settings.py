"""
Django settings for BPMOps project.
...
SECRET_KEY = 'raho!kfn=z#r_h_09&29kj-af1&ulu+r%mjlq3ij*@j1mm_*38'
...
WSGI_APPLICATION = 'BPMOps.wsgi.application'
